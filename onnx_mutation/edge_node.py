...
from onnx_mutation import mutate_utils
from onnx_mutation.utils.onnx_utils import get_dim
from onnx_mutation.mutate_utils import make_value_info
...
def convert_onnx_to_edge(graph):
    name_edge_mapping = onnx_mutation.utils.onnx_utils.name_obj_dict(graph.value_info)
    edges = []
