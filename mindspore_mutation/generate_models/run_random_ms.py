...
# @profile
def run_random_ms(seed_model, mutate_times,num_samples, mr_index, ifapimut,ifTompson,device,train_config):
    ...
    for n in range(mutate_times):
        ...
        try:
            ...
            # name1,instance1,instance_type1,node_type1=random.choice(node_list)
            # print(name1,instance1,instance_type1,node_type1)
            length=len(nodedict)
            print('length', length)
        ...
        # if len(set(layer_type)) > len(tar_set):  # 生成新模型时更新
