...
class ModelStatistics:
    ...
    def __init__(
            ...
            global_layer_info: dict | None = None
    ) -> None:
        ...
        for layer_info in summary_list:
            if layer_info.is_leaf_layer:
                ...
                # print("class_name:", layer_info.class_name)
        ...
        self.formatting.set_layer_name_width(summary_list, global_layer_info=global_layer_info)
    ...
    def __repr__(self) -> str:
        ...
        summary_str = (
            ...
            f"layer number: {self.total_layer_num}\n"
        )
        if self.input_size:
