...
from models.openpose.src.openposenet import OpenPoseNet
from models.openpose.src.dataset import valdata
from models.openpose.src.model_utils.config import config, JointType
from models.openpose.src.model_utils.moxing_adapter import moxing_wrapper
from models.openpose.src.model_utils.device_adapter import get_device_id, get_rank_id, get_device_num
...
def detect_torch(img, network, device):
    orig_img = img.copy()
    orig_img_h, orig_img_w, _ = orig_img.shape
    ...
    logit_pafs = logit_pafs[-1].detach().cpu().numpy()[0]
    logit_heatmap = logit_heatmap[-1].detach().cpu().numpy()[0]
