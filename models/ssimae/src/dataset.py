...
from models.ssimae.src.utils import read_img, get_file_list
...
class Dataloader:
    ...
    def create_dataset(self, rank_size, rank_id,b_size):
        ...
        if repeat != 1:
            ...
            train_image_ds = train_image_ds.shuffle(buffer_size=16 * b_size)
        train_image_ds = train_image_ds.batch(b_size, drop_remainder=True)
