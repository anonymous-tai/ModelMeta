...
from models.ssimae.src.utils import read_img, get_img_names
...
def cal_metric(pred_list, gt_list, image_level=True):
    ...
    if image_level:
        ...
        return ACC_1 / ACC_2, OK_1 / OK_2, NOK_1 / NOK_2, ACC_1 / ACC_2
    ...
    return auc, auc, OK_1 / OK_2, NOK_1 / NOK_2, ACC_1 / ACC_2
