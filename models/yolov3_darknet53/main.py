...
from model_utils.config import config as default_config, get_config
...
if __name__ == '__main__':
    ...
    #         # grad_fn = mindspore.ops.value_and_grad(forward_fn, None, opt.parameters, has_aux=True)
    #         # def train_step(data, batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0,
    #         #                batch_gt_box1,
    #         #                batch_gt_box2):
    #         #     (loss, _), grads = grad_fn(data, batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0,
    #         #                                batch_gt_box1,
    #         #                                batch_gt_box2)
    #         #     loss = mindspore.ops.depend(loss, opt(grads))
    #         #     return loss
    #         # loss = loser(images, network(images), batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0,
    #         #              batch_gt_box1,
    #         #              batch_gt_box2)
    #         loss = network(images, batch_y_true_0, batch_y_true_1, batch_y_true_2, batch_gt_box0, batch_gt_box1,
    #                        batch_gt_box2)
    #         sens = F.fill(loss.dtype, loss.shape, config.loss_scale)
    #         grads = C.GradOperation(get_by_list=True, sens_param=True)(network, opt.parameters)(images, batch_y_true_0,
    #                                                                                             batch_y_true_1,
    #                                                                                             batch_y_true_2,
    #                                                                                             batch_gt_box0,
    #                                                                                             batch_gt_box1,
    #                                                                                             batch_gt_box2, sens)
    #         loss = F.depend(loss, opt(grads))
    #         print("================================")
