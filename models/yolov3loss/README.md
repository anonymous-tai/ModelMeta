...
- Train on [ModelArts](https://support.huaweicloud.com/modelarts/)
  ...
  # (5) Set the code directory to "/path/yolov3loss" on the website UI interface.
  # (6) Set the startup file to "train-VOC.py" on the website UI interface.
...
python eval.py \
    ...
    --pretrained=yolov3loss.ckpt \
    --testing_shape=608 > log.txt 2>&1 &
OR
bash run_eval.sh dataset/coco2017 checkpoint/yolov3loss.ckpt
```
...
python test.py \
    ...
    --testing_shape=608 > log.txt 2>&1 &
OR
bash run_test.sh dataset/coco2017 checkpoint/yolov3loss.ckpt
```
