...
from models.SSD.src.box_utils import jaccard_numpy, ssd_bboxes_encode
import sys
sys.path.append("/root/MSTest/models/ssd/src")
...
def data_to_mindrecord_byte_image(dataset="coco", is_training=True, prefix="ssd.mindrecord", file_num=8):
    ...
    if is_training:
        mindrecord_dir = "/data1/pzy/mindb/COCO2017_SSD/train"
    else:
        mindrecord_dir = "/data1/pzy/mindb/COCO2017_SSD/test"
    mindrecord_path = os.path.join(mindrecord_dir, prefix)

    print("mindrecord_path: ",mindrecord_path)
...
def create_mindrecord(dataset="coco", prefix="ssd.mindrecord", is_training=True):
    ...
    mindrecord_dir = "/data1/pzy/minddb/COCO2017_SSD"
...
if __name__ == '__main__':
    config.data_path=r"/data1/pzy/raw/coco2017"
    config.coco_root=r"/data1/pzy/raw/coco2017"
    mindrecord_file = create_mindrecord("coco", "ssd.mindrecord", False)