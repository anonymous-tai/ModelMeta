...
import mindspore
import numpy as np
from models.SSD.ssd_utils import FpnTopDown, BottomUp, WeightSharedMultiBox
...
class ssd_resnet50fpn_ms(nn.Cell):
    def __init__(self):
        super(ssd_resnet50fpn_ms, self).__init__()
