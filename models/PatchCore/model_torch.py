...
from models.PatchCore.comparer import compare_models
...
if __name__ == '__main__':
    ...
    net_torch.eval()
    param_torch = torch.load("wide_resnet50_2-95faca4d.pth")
    net_torch.load_state_dict(param_torch)
    ...
    mindspore.load_checkpoint("wide_resnet50_2-95faca4d.ckpt", net_ms)
    ...
    mindspore.save_checkpoint(net_ms, "wide_resnet50_2-95faca4d.ckpt")
